...
import { TripleSlopeModel7, IInterestRateModel } from "../../../contracts/money-market/interest-models/TripleSlopeModel7.sol";

// solhint-disable func-name-mixedcase
// solhint-disable contract-name-camelcase
contract TripleSlope7_Test is BaseTest {
  IInterestRateModel private _tripleSlopeModel7;

  function setUp() external {
    _tripleSlopeModel7 = IInterestRateModel(address(new TripleSlopeModel7()));
  }
