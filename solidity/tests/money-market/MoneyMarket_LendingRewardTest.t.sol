...
contract MoneyMarket_LendingRewardTest is MoneyMarket_BaseTest {
  ...
  function testCorrectness_WhenUserAddCollateralAndClaimReward_UserShouldReceivedRewardCorrectly() external {
    ...
    _claimReward(ALICE, _ibToken, address(rewardToken));

    uint256 _expectedReward = 20 ether;

    _assertAccountReward(ALICE, _ibToken, address(rewardToken), _expectedReward, _expectedReward.toInt256());
  ...
  function testCorrectness_WhenUserAddCollateralAndClaimMultipleReward_UserShouldReceivedRewardCorrectly() external {
    ...
    _claimReward(ALICE, _ibToken, address(rewardToken2));

    _assertAccountReward(ALICE, _ibToken, address(rewardToken), 40 ether, 40 ether);
    _assertAccountReward(ALICE, _ibToken, address(rewardToken2), 10 ether, 10 ether);
    ...
    external
  {
    ...
    _claimReward(ALICE, _ibToken, address(rewardToken));
    _assertAccountReward(ALICE, _ibToken, address(rewardToken), _expectedReward + _expectedRewardAfterRemove, 0 ether);
    assertEq(
    ...
    external
  {
    ...
    assertEq(rewardFacet.lenderRewardDebts(BOB, _collatToken, address(rewardToken)), _bobRewardDebtToUpdate);
    assertEq(rewardToken.balanceOf(address(rewardDistributor)), 1000000 ether);
    ...
    _claimReward(ALICE, _collatToken, address(rewardToken));
    _claimReward(BOB, _collatToken, address(rewardToken));
  ...
  function testCorrectness_WhenUserAddMultipleCollateralAndClaimReward_UserShouldReceivedRewardCorrectly() external {
    ...
    _claimReward(ALICE, _ibToken1, address(rewardToken));
    _assertAccountReward(ALICE, _ibToken1, address(rewardToken), _expectedReward1, _expectedReward1.toInt256());
    ...
    _claimReward(ALICE, _ibToken2, address(rewardToken));
  ...
  function testCorrectness_WhenUserAddCollatAndClaimTwice_UserShouldReceivedRewardCorreclty() external {
    ...
    _assertAccountReward(ALICE, _ibToken, address(rewardToken), _expectedFirstReward, _expectedFirstReward.toInt256());
    ...
    assertEq(
      rewardFacet.lenderRewardDebts(ALICE, _ibToken, address(rewardToken)),
  ...
  function _claimReward(
    ...
    vm.prank(_account);
    rewardFacet.claimReward(_collatToken, _rewardToken);
  }
  ...
  function _assertAccountReward(
    ...
    assertEq(rewardFacet.lenderRewardDebts(_account, _collatToken, _rewardToken), _rewardDebt);
  }
}
