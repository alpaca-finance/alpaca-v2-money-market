...
contract AdminFacet_Whitelist is IAdminFacet {
  ...
  ) external onlyWhitelisted nonReentrant returns (address _newIbToken) {
  ...
  function setNonCollatBorrowerOk(address _borrower, bool _isOk) external onlyWhitelisted {
    LibMoneyMarket01.MoneyMarketDiamondStorage storage moneyMarketDs = LibMoneyMarket01.moneyMarketDiamondStorage();
  ...
  function setInterestModel(address _token, address _model) external onlyWhitelisted {
    // Sanity check
  ...
  function setOracle(address _oracle) external onlyWhitelisted {
    // Sanity check
  ...
  function setLiquidationStratsOk(address[] calldata _strats, bool _isOk) external onlyWhitelisted {
    LibMoneyMarket01.MoneyMarketDiamondStorage storage moneyMarketDs = LibMoneyMarket01.moneyMarketDiamondStorage();
  ...
  /// @param _isOk a flag to allow or disallow
  function setRiskManagersOk(address[] calldata _riskManagers, bool _isOk) external onlyWhitelisted {
    LibMoneyMarket01.MoneyMarketDiamondStorage storage moneyMarketDs = LibMoneyMarket01.moneyMarketDiamondStorage();
  ...
  /// @param _isOk a flag to allow or disallow
  function setLiquidatorsOk(address[] calldata _liquidators, bool _isOk) external onlyWhitelisted {
    LibMoneyMarket01.MoneyMarketDiamondStorage storage moneyMarketDs = LibMoneyMarket01.moneyMarketDiamondStorage();
  ...
  /// @param _isOk a flag to allow or disallow
  function setAccountManagersOk(address[] calldata _accountManagers, bool _isOk) external onlyWhitelisted {
    LibMoneyMarket01.MoneyMarketDiamondStorage storage moneyMarketDs = LibMoneyMarket01.moneyMarketDiamondStorage();
  ...
  function setLiquidationTreasury(address _treasury) external onlyWhitelisted {
  ...
  function setFlashloanFees(uint16 _flashloanFeeBps, uint16 _lenderFlashloanBps) external onlyWhitelisted {
  ...
  function setRepurchaseRewardModel(IFeeModel _newRepurchaseRewardModel) external onlyWhitelisted {
    // Sanity check
  ...
  function setIbTokenImplementation(address _newImplementation) external onlyWhitelisted {
    // sanity check
  ...
  function setDebtTokenImplementation(address _newImplementation) external onlyWhitelisted {
    // sanity check
  ...
  function setProtocolConfigs(ProtocolConfigInput[] calldata _protocolConfigInputs) external onlyWhitelisted {
    LibMoneyMarket01.MoneyMarketDiamondStorage storage moneyMarketDs = LibMoneyMarket01.moneyMarketDiamondStorage();
  ...
  function setLiquidationParams(uint16 _newMaxLiquidateBps, uint16 _newLiquidationThreshold) external onlyWhitelisted {
  ...
  function setMinDebtSize(uint256 _newValue) external onlyWhitelisted {
    LibMoneyMarket01.MoneyMarketDiamondStorage storage moneyMarketDs = LibMoneyMarket01.moneyMarketDiamondStorage();
  ...
  function topUpTokenReserve(address _token, uint256 _amount) external onlyWhitelisted {
    LibMoneyMarket01.MoneyMarketDiamondStorage storage moneyMarketDs = LibMoneyMarket01.moneyMarketDiamondStorage();
  ...
  function setEmergencyPaused(bool _isPaused) external onlyWhitelisted {
    LibMoneyMarket01.MoneyMarketDiamondStorage storage moneyMarketDs = LibMoneyMarket01.moneyMarketDiamondStorage();
  ...
  function setWhitelistedCallers(address[] calldata _callers, bool _allow) external onlyWhitelisted {
