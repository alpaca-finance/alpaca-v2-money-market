...
// Implementation based on OpenZeppelin Contracts (last updated v4.7.0) (token/ERC20/ERC20.sol)
...
contract InterestBearingToken is Context, IERC20, IERC20Metadata, Ownable, Initializable {
  ...
  function name() public view virtual override returns (string memory) {
    return string.concat("Interest Bearing ", IERC20Metadata(_underlying).symbol());
  }
  ...
  function symbol() public view virtual override returns (string memory) {
    return string.concat("ib", IERC20Metadata(_underlying).symbol());
  }
