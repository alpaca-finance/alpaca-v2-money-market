...
contract LYFLiquidationFacet is ILYFLiquidationFacet {
  ...
  function repurchase(
    ...
    // 4. transfer
    _debtToken.safeTransferFrom(msg.sender, address(this), _actualDebtToRepurchase);
    ...
    internal
  {
    ...
    _params.collatToken.safeTransfer(
    ...
    _params.repayToken.safeTransfer(lyfDs.treasury, _feeToTreasury);
  ...
  function _ibLiquidationCall(
    ...
    _collatUnderlyingToken.safeTransfer(_params.liquidationStrat, _returnedUnderlyingAmount);
  ...
  function _repayAndAddRemainingToCollat(
    ...
    if (_actualAmountToRepay > 0) {
      ...
      _token.safeTransfer(lyfDs.treasury, _feeToTreasury);
    }
