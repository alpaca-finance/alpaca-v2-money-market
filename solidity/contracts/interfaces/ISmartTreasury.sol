...
interface ISmartTreasury {
  ...
  function setAllocPoints(uint16 _revenueAllocPoint, uint16 _devAllocPoint, uint16 _burnAllocPoint) external;
  ...
  function setTreasuryAddresses(address _revenueTreasury, address _devTreasury, address _burnTreasury) external;
